    ...
    Tables: {
      ...
      matches: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "matches_matched_by_fkey"
            columns: ["matched_by"]
            isOneToOne: false
      ...
      user_trust_metrics: {
        Row: {
          account_longevity_months: number | null
          ...
          quick_responses: number | null
          spam_posts: number | null
          successful_matches: number | null
          unresponsive_incidents: number | null
          updated_at: string | null
          user_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_trust_metrics_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
